                          ...
                          onPressed: () async {
                            ...
                            if (emailValidate == true &&
                              ...
                              try {
                                ...
                                if (newUser != null) {
                                  await _firestore.collection('users').doc(_auth.currentUser.email).set({'fullname': username});
                                  Navigator.push(
                                      context,
                                      MaterialPageRoute(
                      ...
                      children: [
                        GestureDetector(
                          ...
                          onTap: () async {
                            ...
                            await _firestore.collection('users').doc(user.email).set({'fullname': user.displayName});
